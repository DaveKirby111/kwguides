<script>
  ...
  const commands = [
    {
      name: "god mode",
      input: "tgm",
      desc: "toggle god mode. Infinite health, Inf. ammo, etc.",
    },
...

    {
      ...
      desc: "give the player caps",
    },

    {
      name: "fusion cores",
      input: "player.additem 75fe4 (amount)",
      desc: "toggle god mode. Infinite health, Inf. ammo, etc.",
    },    
  ...
  <div id="guides" class="guides">
    ...
    <div class="guide-sections">
        ...
        <ul class="skip">
          <li><a href="#bobble">bobbleheads</a></li>
        </ul>
      </div>

      <div class="bobble" id="bobble">
        <h4>bobbleheads</h4>
